...
Новые репозитории в организации Miluino также создаёт только администратор. После создания он добавляет их в утверждённый каталог репозиториев и, при необходимости, в наборы bootstrap-скрипта.
